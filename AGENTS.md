...
| Path | Purpose |
|---|---|
| [`docs/specs/2026-05-09-vertix-blockchain-design.md`](./docs/specs/2026-05-09-vertix-blockchain-design.md) | The **approved** chain design spec |
...
4. Verify the change is consistent with the approved spec ([`docs/specs/2026-05-09-vertix-blockchain-design.md`](./docs/specs/2026-05-09-vertix-blockchain-design.md)).
...
- **The spec wins.** If a doc disagrees with [`docs/specs/2026-05-09-vertix-blockchain-design.md`](./docs/specs/2026-05-09-vertix-blockchain-design.md), the spec is correct — flag the disagreement in your PR.
