...
// AppConfig is the depinject module configuration (name kept for runtime wiring).
//
//nolint:revive // stutter AppConfig is required by Cosmos depinject convention
